...
#define MVPP22_CLS_HEK_OPT_VLAN		BIT(0)
#define MVPP22_CLS_HEK_OPT_IP4SA	BIT(1)
#define MVPP22_CLS_HEK_OPT_IP4DA	BIT(2)
#define MVPP22_CLS_HEK_OPT_IP6SA	BIT(3)
#define MVPP22_CLS_HEK_OPT_IP6DA	BIT(4)
#define MVPP22_CLS_HEK_OPT_L4SIP	BIT(5)
#define MVPP22_CLS_HEK_OPT_L4DIP	BIT(6)
#define MVPP22_CLS_HEK_N_FIELDS		7
